...
(function () {
  var NAV = [
    ...
    { file: "implementation.md", title: "Implementation & Isolation", html: "implementation.html" },
  ...
  // Lazy-load Mermaid (only when a doc actually has diagrams) and render any
  // ```mermaid fenced blocks marked turned into <pre><code class=language-mermaid>.
